<%-- 
    Document   : SanPhamMoi
    Created on : Dec 9, 2016, 1:00:18 PM
    Author     : kelvi
--%>
...
<html>
    ...
    <body>
        <%
            ...
            total = sanPhamDAO.countNewProduct();
            if (total <= 16) {
                firstResult = 0;
                maxResult = total;
            } else {
            ...
            ArrayList<SanPham> listsp = sanPhamDAO.getListNewProduct(firstResult, maxResult);
                        ...
                        <div class="row" align ="right">
                            ...
                            <ul class="pagination" >
                                ...
                                <li><a href="SanPhamMoi.jsp?pages=<%=i%>"><%=i%></a></li>
                                    <%}%>
                                <li><a href="SanPhamMoi.jsp?pages=<%=(total / 16) + 1%>" class="pag">&raquo;</a></li>
                            </ul>
                            <%}else{%>
                            <%}%>
                        </div>
